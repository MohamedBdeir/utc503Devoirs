class Etudiant:
    """Classe définissant un étudiant  caratérisé par un numero, un nom, un prenom et un niveau"""
    def __init__(self, numero, nom, prenom, niveau):
        ...
        if(niveau in ['A', 'B', 'C']):
            ...
            print("Le niveau peut prendre uniquement les valeurs A, B  ou C. \
                    Le niveau a ete définit A car donnée saisie invalide")
            self._niveau = "A" 
